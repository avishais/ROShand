...
class RecordData{
	...
	std::vector<std::vector<int>> posx_;
	std::vector<std::vector<int>> posy_;
	std::vector<std::vector<double>> angles_;
	std::vector<std::vector<float>> gripper_pos_, gripper_load_;
	std::vector<std::vector<double>> gripper_vel_ref_, gripper_pos_ref_;
	...
	ros::Subscriber sub_image_space_pose_, sub_gripper_pos_, sub_gripper_load_, sub_gripper_vel_ref_, sub_gripper_pos_ref_, sub_cartesian_vel_ref_, sub_curvatures_, sub_normals_, sub_contact_angles_, sub_out_filename_;
